...
function Profile() {
  ...
  return (
    <section style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1 }}>
      <div className="container py-5"  >
        <div className="card">
          <div className="rounded-top text-white d-flex flex-row" style={{ backgroundColor: '#000', height: '200px',  width:"5  50px"}}>
            <div className="ms-4 mt-5 d-flex flex-column" style={{ width: '150px' }}>
              {profileImage && <img src={profileImage} alt="Profile" className="img-fluid img-thumbnail mt-4 mb-2" style={{ width: '150px' }} />}
              <input type="file" accept="image/*" onChange={handleAddPhoto} />
              <button type="button" className="btn btn-outline-dark" data-mdb-ripple-color="dark" onClick={() => navigate('/editprofile')}>
                Edit profile
              </button>
            </div>
            <div className="ms-3" style={{ marginTop: '130px' }}>
