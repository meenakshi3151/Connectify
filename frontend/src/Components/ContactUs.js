...
export default function ContactUs() {
  ...
  return (
    <div id="contact">
      <section
        className="text-gray-900 body-font relative"
        style={sectionStyle}
      >
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className ="sm:text-7xl text-7xl mb-4 text-black" >
              Contact Us
            </h1>
          ...
          <form action="https://formsubmit.co/https://formsubmit.co/el/gusahi" method="POST" >
